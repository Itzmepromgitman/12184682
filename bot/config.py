...
class Config:
    def __init__(self):
        try:
            ...
            self.BOT_TOKEN = config("BOT_TOKEN", "7338693492:AAF_CG3U7oSkEqFJOBb5wPJWKd8r3FJfJpY")
            ...
            self.DBNAME = config("DBNAME", default="Ensgha")
            ...
            self.RELEASER = config("RELEASER", default="AW|AnimeWanderer")
