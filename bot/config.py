...
class Config:
    def __init__(self):
        try:
            ...
            self.BOT_TOKEN = config("BOT_TOKEN", "7535592235:AAFoK49npJ9Lr1Xqai4cFcY0WsDXCAVq2H4")
            self.CACHE_DL = config("CACHE_DL", default=False, cast=bool)
            self.CAP_DECO = config("CAP_DECO", default="◉")
            self.C_LINK = config("C_LINK", default="")
            ...
            self.DBNAME = config("DBNAME", default="Enajshe")
            ...
            self.LOG_CHANNEL = config("LOG_CHANNEL", default=-1002339454711, cast=int)
            ...
            self.OWNER = config("OWNER", "5426061889")
